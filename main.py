import requests, sys, time, os, argparse, isodate
...
header = ["video_id"] + categories + ["trending_date", "tags", "view_count", "likes", "dislikes",
...
def get_videos(items):
    ...
    for video in items:
        ...
        features = [prepare_feature(snippet.get(feature, "")) for feature in categories]
        ...
        duration = isodate.parse_duration(contentDetails.get('duration'))
